...
## 핵심 규칙
- **`handoff/SESSION.md` 는 항상 최신 상태.** 세션 부팅의 단일 진입 문서.
- **매 Sprint 종료 시 자동 갱신** (헌법 8조: Section 6·History만 자동, 나머지는 명시 승인).
- 부팅 명령: `@CONSTITUTION.md @handoff/SESSION.md 읽고 진행`
...
## 폴더 구조 (역할 분리)
- `handoff/SESSION.md` — 세션 인계 문서 (committed, 부팅용)
- `handoff/README.md` — 본 표준 문서 (committed)
- `handoff/bridge-<timestamp>.md` / `handoff/bridge/` — Subscription Bridge [B] 산출물 (gitignored, 자동 생성)
